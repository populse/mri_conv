...
public class OpenBids implements ParamMRI2 {
	
	private ImagePlus imp;
	
	public OpenBids(String noSeq, Boolean show, String title) {
...
//		FileManagerFrame.dlg.setTitle("Opening image ...");
...
//			imp = convertToGray32(imp);
		...
		imp.setSlice(nImage/2);

		if (tmp.contains("INT8") || tmp.contains("FLOAT8"))
